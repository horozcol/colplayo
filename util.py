...
def read_license_plate(license_plate_crop):
    ...
    reader.readtext(license_plate_crop)
...
def get_car(license_plate, vehicle_track_ids):
    ...
    for j in range(len(vehicle_track_ids)):
        #search between all bboxes the plate sent it
        xcar1, xcar2, ycar1, ycar2, car_id = vehicle_track_ids[j]
        #verify the plate is inside bbox:
